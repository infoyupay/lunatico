...
public class MonetaryDecimalConverter extends StringConverter<BigDecimal> {
    ...
    @Contract(" -> new")
    public static @NotNull MonetaryDecimalConverter forKardex() {
        return new MonetaryDecimalConverter(8, true);
    }
